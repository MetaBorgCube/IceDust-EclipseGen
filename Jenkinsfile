...
node {
  ...
  stage('Generate Eclipses'){
    exec 'sh spoofax-deploy/releng/run.sh gen-eclipse -d dist/eclipse -o macosx -h x64 -a -j --archive-jre-separately --install icedust2.eclipse.feature.feature.group --repo http://buildfarm.metaborg.org/job/metaborgcube/job/IceDust/job/artifact%252Fecoop2017/lastSuccessfulBuild/artifact/icedust2.eclipse.site/target/site/'
